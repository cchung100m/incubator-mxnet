...
"""
Generate helper function class for download coco dataset
...
class COCO:
    """
    Generate  Microsoft COCO helper class for reading and visualizing annotations.
    """
    ...
    def createIndex(self):
        """
        Create index of Microsoft COCO helper class or reading and visualizing annotations.
        """
        # create index
    ...
    def getCatIds(self, catNms=None, supNms=None, catIds=None):
        ...
        catIds = catIds if isinstance(catIds, list) == list else [catIds]
    ...
    def loadRes(self, resFile):
        ...
        tic = time.time()
        if isinstance(resFile, string_types):
