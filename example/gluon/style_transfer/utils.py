...
# under the License.
"""
Helper functions to generate Neural style transfer
"""
import collections
import os
import numbers
...
class StyleLoader():
    """
    Load the prepared style content
    """
...
def init_vgg_params(vgg, model_folder, ctx):
    if not os.path.exists(os.path.join(model_folder, 'mxvgg.params')):
        os.system('wget https://www.dropbox.com/s/7c92s0guekwrwzf/mxvgg.params?dl=1 -O' +
                  os.path.join(model_folder, 'mxvgg.params'))
