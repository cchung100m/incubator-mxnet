...
# under the License.
"""
Generate helper function for the implementation of DDPG
"""
import numpy as np
import mxnet as mx
...
def define_qfunc(obs, act):
    ...
    Generate q function
    """
    net = mx.symbol.FullyConnected(data=obs, name="qfunc_fc1", num_hidden=32)
...
def rollout(env, agent, max_path_length=np.inf):
    """
    Reset environment and get reward
    """
    reward = []
    o = env.reset()
    # agent.reset()
