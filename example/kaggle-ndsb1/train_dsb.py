...
"""
Train DSD Dense-Sparse-Dense for Deep Neural Networks
"""
...
def get_iterator(arguments, kv):
    ...
    train = mx.io.ImageRecordIter(
        path_imgrec=arguments.data_dir + "tr.rec",
        mean_r=128,
        mean_g=128,
        mean_b=128,
        scale=0.0078125,
    ...
    val = mx.io.ImageRecordIter(
        path_imgrec=arguments.data_dir + "va.rec",
        mean_r=128,
        mean_b=128,
        mean_g=128,
        scale=0.0078125,
