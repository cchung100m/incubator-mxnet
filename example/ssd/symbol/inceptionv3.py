...
def Inception7A(data, num_1x1, num_3x3_red, num_3x3_1, num_3x3_2, num_5x5_red, num_5x5, pool, proj, name):
    """
    Construct the stage 3 of inceptionv3 model
    """
...
def Inception7C(data,
                ...
                name):
    """
    Construct the stage 4 of inceptionv3 model
    """
...
def Inception7E(data,
                ...
                name):
    """
    Construct the stage 5 of inceptionv3 model
    """
    tower_1x1 = Conv(data=data, num_filter=num_1x1, kernel=(1, 1), name=('%s_conv' % name))
...
def get_symbol(num_classes=1000, **kwargs):
    """
    Get the softmax value of inceptionv3 model
    """
